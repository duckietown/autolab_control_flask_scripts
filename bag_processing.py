...
def start_bag_processing(input_bag_name, output_bag_name, mount_computer_side, mount_container_side="/data"):
    ...
    print(watchtowers)
    print(autobots)
    for watchtower_id in watchtowers[0:1]:
        ...
        try:
            ...
            container = client.containers.run(
                image="duckietown/apriltag-processor:master19-amd64", network="host", detach=True, environment=env, volumes=volume, name=name)
            print("Success: ")
